...
class Schedule {
    ...
    public function create($student_id, $instructor_id, $vehicle_id, $branch_id, $start_time, $end_time) {
        $stmt = $this->pdo->prepare(
           "INSERT INTO schedule (student_id, instructor_id, vehicle_id, branch_id, start_time, end_time, status)
             VALUES (?, ?, ?, ?, ?, ?, 'booked')"
        );
        return $stmt->execute([$student_id, $instructor_id, $vehicle_id, $branch_id, $start_time, $end_time]);
    }
